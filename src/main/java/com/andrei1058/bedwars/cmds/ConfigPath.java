...
public class ConfigPath {
    ...
    private static String GAME_WIN_PATH = "game-win";

    public static String GAME_WIN_ENABLE = GAME_WIN_PATH + ".enable";
    private static String GAME_WIN_FOR_EACH_WINNER = GAME_WIN_PATH + ".for-each-winner";
    ...
    private static String REGULAR_KILL_PATH = "regular-kill";
    private static String REGULAR_KILL_FOR_KILLER = REGULAR_KILL_PATH + ".for-killer";
    ...
    private static String REGULAR_KILL_FOR_VICTIM_WITH_KILLER = REGULAR_KILL_PATH + ".for-victim-with-killer";
    ...
    private static String REGULAR_KILL_FOR_VICTIM_NO_KILLER = REGULAR_KILL_PATH + ".for-victim-without-killer";
    ...
    private static String FINAL_KILL_PATH = "regular-kill";
    private static String FINAL_KILL_FOR_KILLER = FINAL_KILL_PATH + ".for-killer";
    ...
    private static String FINAL_KILL_FOR_VICTIM_WITH_KILLER = FINAL_KILL_PATH + ".for-victim-with-killer";
    ...
    private static String FINAL_KILL_FOR_VICTIM_NO_KILLER = FINAL_KILL_PATH + ".for-victim-without-killer";
    ...
    private static String BED_DESTROY_PATH = "bed-destroy";

    public static String BED_DESTROY_ENABLE = BED_DESTROY_PATH + ".enable";
    private static String BED_DESTROY_FOR_DESTROYER = BED_DESTROY_PATH + ".for-destroyer-player";
    ...
    private static String BED_DESTROY_FOR_DESTROYERS = BED_DESTROY_PATH + ".for-destroyer-team";
